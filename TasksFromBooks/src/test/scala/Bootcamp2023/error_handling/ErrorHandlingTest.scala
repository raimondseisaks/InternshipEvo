package Bootcamp2023.error_handling

import cats.syntax.all._
import reisaks.Bootcamp2023.error_handling.ErrorHandling._
...
class ErrorHandlingTest extends AnyFlatSpec with Matchers with ScalaCheckDrivenPropertyChecks {
